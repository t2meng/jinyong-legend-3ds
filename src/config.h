...
#elif defined(_3DS)
    #define CONFIG_FILE "sdmc:/3ds/jy/config.lua"
    #define DEBUG_FILE "sdmc:/3ds/jy/debug.txt"
    #define ERROR_FILE "sdmc:/3ds/jy/error.txt"
    #define HZMB_FILE "sdmc:/3ds/jy/hzmb.dat"
#else
